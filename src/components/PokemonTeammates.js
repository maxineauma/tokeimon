...
class PokemonTeammates extends React.Component {
    ...
    async componentDidMount() {
        ...
        this.setState({teammates: pokemonData[this.props.name]["common_teammates"]});
        ...
        return( 
            ...
            <>
                <h1>Teammates</h1>
                    ...
                    dataSource={
                        Object.keys(this.state.teammates || {}).map((v, i) => {
                            return(
                                {"key": i, "teammate": v, "usage": this.state.teammates[v] + "%"}
                            )
                        })
                    }/>
            </>
